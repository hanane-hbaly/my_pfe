...
--
-- Hôte : 127.0.0.1
-- Généré le : mar. 27 fév. 2024 à 14:08
...
('2024-02-27', 120, '5432hh', 98, 4),
('2024-02-27', 121, '5432hh', 92, 1);
...
('114', '011c945f30ce2cbafc452f39840f025693339c42', 1, 'vendeur', 'null.png'),
('12', '12', 1, 'admin', 'null.png'),
('hanane23', '123', 1, 'admin', '7396AVATAR3.jpg'),
('ikram23', '1234', 1, 'vendeur', 'null.png'),
('1234', '2abd55e001c524cb2cf6300a89ca6366848a77d5', 0, 'vendeur', 'null.png'),
('SOBHI', '3244f8e7767708d7e5e6412a3740293ea192b10e', 0, 'vendeur', 'null.png'),
...
('011c945f30ce2cbafc452f39840f025693339c42', 'ff', 'KK', '0587906542', 98, '114', 1);
...
--
ALTER TABLE `affectation`
  MODIFY `AffectationID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=122;
...
--
ALTER TABLE `commande`
  MODIFY `CommandeID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;
...
--
ALTER TABLE `quantitecom`
  MODIFY `QuantiteID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=112;
...
--
ALTER TABLE `vendeur`
  MODIFY `VendeurID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=99;
